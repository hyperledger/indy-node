...
tests_require = ['attrs==19.1.0', 'pytest==3.3.1', 'pytest-xdist==1.22.1', 'python3-indy==1.11.0-dev-1343', 'pytest-asyncio==0.8.0']
...
setup(
    ...
    install_requires=['indy-plenum==1.10.0.dev916',
