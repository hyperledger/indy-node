...
class AuthRuleTest(AbstractTest):
    ...
    def run(self):
        ...
        with pytest.raises(RequestRejectedException):
            sdk_send_and_check_auth_rule_request(self.looper, self.test_nym, self.sdk_pool_handle)
        ...
        self.send_and_check(self.default_auth_rule, self.test_nym)
    ...
    def get_default_auth_rule(self):
        ...
        return sdk_gen_request(operation, identifier=self.test_nym[1])
