...
from indy_node.test.api.helper import validate_write_reply, validate_attrib_txn, sdk_sign_and_submit
...
def execute_attrib_txn(looper, sdk_pool_handle, sdk_wallet_steward, xhash, raw, enc):
    ...
    return sdk_sign_and_submit(looper, sdk_pool_handle, sdk_wallet_steward, request)
