from indy_common.constants import NYM, NODE, ATTRIB, SCHEMA, CLAIM_DEF, DISCLO, GET_ATTR, GET_NYM, GET_TXNS, \
    GET_SCHEMA, SET_CONTEXT, GET_CONTEXT, SET_RS_MAPPING, GET_RS_MAPPING, SET_RS_SCHEMA, GET_RS_SCHEMA, \
    GET_CLAIM_DEF, POOL_UPGRADE, NODE_UPGRADE, POOL_CONFIG, REVOC_REG_DEF, REVOC_REG_ENTRY, \
...
def test_transactions_are_encoded():
    ...
    assert SET_RS_MAPPING == "204"
    assert GET_RS_MAPPING == "304"
...
def test_transaction_enum_encoded():
    ...
    assert IndyTransactions.SET_RS_MAPPING.value == "204"
    assert IndyTransactions.GET_RS_MAPPING.value == "304"
