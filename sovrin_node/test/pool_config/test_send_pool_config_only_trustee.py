...
def test_only_trustee_send_pool_config_wtff(nodeSet, tdir, looper, trustee, trusteeWallet, poolConfigWTFF):
...
def test_only_trustee_send_pool_config_wfff(nodeSet, tdir, looper, trustee, trusteeWallet, poolConfigWFFF):
    stClient, stWallet = getClientAddedWithRole(nodeSet, tdir, looper, trustee, trusteeWallet, 'tmpname', STEWARD)
